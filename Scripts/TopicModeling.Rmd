...
head(sort(table(reviews), decreasing = TRUE), 15) #the 15 most frequent words are not interesting because they consist of closed-class words, i.e. words that serve a grammatical function.Getting rid of grammatical words would have the advantage of focusing on open class words (lexical words).
```
